		...
		<section className='flex justify-center py-1'>
			<Card
				...
				<CardBody className='gap-4'>
					...
					{sent ? (
						<p className='text-center text-golden-200 text-lg font-medium'>
						...
						<>
							...
							<div className='flex flex-row justify-center'>
								<Button
									...
									size='lg'
									onPress={handleSend}
									className='bg-gradient-to-r from-[#f2d28b] to-[#e8b85c] text-lg text-gray-800 w-max font-semibold transition-all hover:-translate-y-0.5 hover:shadow-lg active:translate-y-0'>
									सेंड करें
								</Button>
							</div>
						</>
