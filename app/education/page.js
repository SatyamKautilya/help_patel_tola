		...
		<div className='min-h-screen bg-gradient-to-b from-slate-900 via-slate-950 to-black text-white'>
			...
			<div className='sticky top-0 z-40 bg-slate-900/80 backdrop-blur-xl border-b border-white/5'>
				<div className='flex items-center gap-3 px-4 py-3'>
					...
					<h1 className='text-lg font-bold'>करियर मार्गदर्शन</h1>
				</div>
			</div>
			...
			<div className='px-5 pt-6 pb-4'>
				<motion.div
					...
					<p className='text-sm text-white/50 mt-2 leading-relaxed'>
						हर profession का complete roadmap - 10वीं से लेकर नौकरी
						तक। AI assistant से पूछें कोई भी सवाल।
					</p>
				</motion.div>
			</div>
					...
					{careerOrder.map((key, index) => {
						...
						return (
							<motion.div
								...
								whileTap={{ scale: 0.96 }}
								onClick={() =>
									router.push(`/education/${career.id}`)
								}
			...
			<motion.div
				...
				<p className='text-xs text-white/25'>
					प्रत्येक करियर में AI assistant उपलब्ध है आपके सवालों के
					लिए
				</p>
			</motion.div>
		</div>
